DDWC001 ;ven/smh&toad-web: services ;2016-04-02 23:04
 ...
 ; clarify subroutine structure. getFieldAttr: use $$JSN. passim.
 ...
 ;   testing subroutines:
 ;
 ; TEST: test DD^DDWC001, uses asserts
 ; TEST2: test $$VALS^DDWC001, uses zwrites
 ...
 ; move from DDW namespace (belongs to Paul Keltz text editor) to DMW
 ; create a new routine for each supported web service
 ;   e.g., dmwdd for DD^DDWC001, dmwval for $$VALS^DDWC001, etc.
 ; move tests to DMU, DMUW
